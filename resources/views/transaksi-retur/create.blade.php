...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="my-3">
                <label for="" class="form-control">Detail Barang</label>
        ...
        $(document).ready(function() {
            ...
            $("#btn-add").on("click", function(e) {
                ...
                if (qty > selectedItem.qty) {
                    swal({
                        icon: 'warning',
                        title: 'Perhatian',
                        text: 'Qty Melebihi barang yang di kirim',
                        timer: 3000
                    })
                }
                ...
                $("#selec-transaksi-items").val('').trigger('change')
                $("#qty").val('')
                $("#note").val('')
                renderTable()
            });
            ...
            function renderTable() {
                ...
                returItems.forEach((item, index) => {
                    let row = `
                        <tr>
                            ...
                            <td>
                                <button class='btn btn-round btn-sm btn-icon btn-danger btn-delete' data-varian-id='${item.varian_id}'>
                ...
                if (returItems.length < 1) {
                    tableBody.append(`
                        <tr>
                            <td class="text-center" colspan="6">Tidak ada data yang di retur</td>
                        </tr>
                    `)
                }
            ...
            $("#btn-submit-retur").on("click", function() {
                ...
                if (returItems.length < 1) {
                    swal({
                        icon: 'warning',
                        title: 'Perhatian',
                        text: 'Tidak ada produk yang di retur',
                        timer: 3000
                    })
                    return;
                }
